...
// Get all WB_TICKET from WB_OUT By MWERKS
const getwbticket= async (req, res) => {
    try {
        const pool = await poolPromise;
        const result = await pool.request()
...
// Update Gross and Net Weight in WB_OUT by WB_TICKET AND MWERKS
const updateBargeQuantity = async (req, res) => {
...
// View Gross and Net Weight in WB_OUT by WB_TICKET AND MWERKS
const viewBargeQuantity = async (req, res) => {
