...
const navItems = [
  ...
  { path: '/ffbreupload', label: 'FFB Reupload', requiredPermission: 'WB_FFB_REUPLOAD' },
  { path: '/splitso', label: 'Split SO', requiredPermission: 'WB_SPLIT_SO' },
  { path: '/cpupdate', label: 'Car Plate Update', requiredPermission: 'WB_CP_UPDATE' },
  { path: '/barge', label: 'Barge Update', requiredPermission: 'WB_BARGE_UPDATE' },
  { path: '/sqlexecute', label: 'SQL Executor', requiredPermission: 'WB_SQL_EXECUTE' },
];
...
const Sidebar = () => {
  ...
  const navLinkClasses = ({ isActive }) =>
    `flex w-full items-center p-2 text-gray-300 rounded-lg hover:bg-gray-700 group ${isActive ? 'bg-gray-700' : ''}`;
