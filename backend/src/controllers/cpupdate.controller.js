...
export const getWerks = async (req, res) => {
  try {
    const pool = await poolPromise;
    const result = await pool.request().query('SELECT DISTINCT WERKS FROM [dbo].[WB_IN] ORDER BY WERKS');
...
export const updateCarPlateOut = async (req, res) => {
...
export const updateCarPlateIn = async (req, res) => {
...
export const viewCarPlateOut = async (req, res) => {
...
export const viewCarPlateIn = async (req, res) => {
...
export const getWerksByTicket = async (req, res) => {
...
export const getMWerksByTicket = async (req, res) => {
  const { wb_ticket } = req.query;
  if (!wb_ticket) {
    return res.status(400).json({ error: 'wb_ticket is required' });
  }
